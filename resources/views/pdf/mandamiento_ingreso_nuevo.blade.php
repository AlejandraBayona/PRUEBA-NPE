                    ...
                    <tr style="min-height:250px;">
                        ...
                        <td class="contenedor-titulo">
                            <div>
                                ...
                                <div>
                                    <h2>No.{{$dataBarcodeNpe['referencia']}}{{ $dataBarcodeNpe['correlativo'] }}</h2>
                                </div>
                            </div>
                    ...
                    <tr>
                        <td rowspan="3" class="td-1" style="margin-top:0!important;padding-top:0!important;">
                            <div class="codebar" style="margin-top:0!important;padding-top:0!important;padding-bottom:61px!important;">
                                <img src="{{ public_path() }}/barcode_{{ $order }}.png" alt="logo">
                            </div>
                        </td>
                        <td style="width: 90%;">
                                ...
                                <tbody>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td style="margin-bottom:0!important;padding-bottom:0!important;">
                                                            <h1 style="padding-bottom:10px;">{{ $datosFormateados['nitConGuiones'] }}</h1>
                                                        </td>
                                                    </tr>
                                                </thead>
                                            </table>
                                    ...
                                    <tr style="border-bottom:1px solid!important;margin-bottom:0!important;padding-bottom:0!important;">
                                        <td style="width:50%!important;border:none;margin-bottom:0!important;padding-bottom:0!important;">
                                            <h2>{{ mb_strtoupper($dataToSendHacienda['firstName']) }} {{ mb_strtoupper($dataToSendHacienda['lastName']) }}</h2>
                                        </td>
                                    </tr>
                                    ...
                                    <table class="personal-table" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="number-ref" style="text-align:right;padding-right:22px;padding-bottom:17px;padding-top:9px;">{{ $datosEntidad['origenPago'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom:17px;padding-left:6px;" class="descriptions-pago">Correlativo:</td>
                                                <td class="number-ref" style="text-align:right;padding-right:22px;padding-bottom:17px;">{{ $dataBarcodeNpe['correlativo'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom:17px;padding-left:6px;" class="descriptions-pago">Ultima fecha de pago:</td>
                                                <td class="number-ref" style="text-align:right;padding-right:22px;padding-bottom:17px;">{{ $dataBarcodeNpe['npeFechaVencimiento'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding-bottom:17px;padding-left:6px;" class="descriptions-pago">Total a Pagar (US $):</td>
                                                <td class="number-ref" style="text-align:right;padding-right:22px;padding-bottom:19px;">{{ $dataToSendHacienda['totalAmount'] }}</td>
                                            </tr>
                                            <tr>
                                                <td colspan=2 style="padding-left:6px;padding-bottom:9px;" class="descriptions-npe">NPE:</td>
                                            </tr>
                                            <tr>
                                                <td colspan=2 style="padding-bottom:10px;padding-left:17px;" class="number-npe">{{ $datosFormateados['npeConFormato'] }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                    ...
                                    <div>
                                        <table class="personal-table" cellspacing="0" cellpadding="0">
                                            <tbody style="vertical-align: sub;">
                                                <tr>
                                                    <td></td>
                                                    <td class="descriptions-right-zone" style="text-align:right;padding-top:10px;">{{ $dataToSendHacienda['account'] }}</td>
                                                    <td class="descriptions-right-zone" style="text-align:right;padding-right:5px;padding-top:10px;">{{ $dataToSendHacienda['totalAmount'] }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan=3 style="margin-top:15px!important;padding-left:10px;" class="descriptions-right-zone"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan=3 style="margin-top:15px!important;padding-left:10px;" class="descriptions-right-zone">U. {{ $dataToSendHacienda['userAccount']  }}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan=3 style="padding-bottom:7px;padding-top:10px;padding-left:10px;" class="descriptions-right-zone">Tipo Documento. {{ $dataBarcodeNpe['tipoComprobante'] }}</td>
                                                </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="padding-left:6px;text-align:center;border-top:1px solid;" class="descriptions-datetime">
                                                    Fecha y hora de emision: {{ $datosFormateados['fechaHoraActual'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                        </tbody>
